...
const MonthEnd = () => {
  ...
  if (selectedCustomer) {
    ...
    return (
      <MainLayout title="Record Payment" showBack>
  ...
  className="w-full px-5 py-5 bg-white rounded-2xl outline-none text-2xl font-bold text-gray-900 border border-gray-100 focus:border-green-400 focus:ring-4 focus:ring-green-500/10 transition-all placeholder:text-gray-200 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
  placeholder="0.00"
  autoFocus
/>
          </div>
          ...
          {paidAmount > 0 && rollover > 0 && (
            <div
              ...
              style={{ backgroundColor: 'rgba(234,88,12,0.05)', border: '1px solid rgba(234,88,12,0.12)' }}
            >
  ...
  return (
    <MainLayout title={`${MONTH_NAME} Close`} showBack>
      <div className="max-w-2xl">
        ...
        {/* Debtor List */}
        <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">All Accounts</p>
          ...
          {MOCK_CUSTOMERS.map(customer => {
            ...
            return (
              <div
                ...
                className={`bg-white rounded-2xl p-4 flex items-center justify-between transition-all ${
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {paid && customerRollover > 0 && (
                      <p className="text-[9px] font-black text-orange-500 mt-0.5">
                        Rollover: {formatZAR(customerRollover)}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="text-right">
                    <p className={`font-black text-sm ${paid ? 'text-green-600' : 'text-red-600'}`}>
