// src/pages/admin/Shared.jsx
// Shared UI primitives used across all admin page components.
...
export function StatusBadge({ status }) {
  const map = {
    ...
    low:        ["badge-gray",   "Low"],
    restaurant: ["badge-blue",   "Restaurant"],
    shop:       ["badge-gray",   "Shop"],
    customer:   ["badge-blue",   "Customer"],
    cashier:    ["badge-green",  "Cashier"],
  };
