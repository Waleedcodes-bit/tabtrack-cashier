  ...
  return (
    <MainLayout title="Business Profile" showBack>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        {/* ── Left col: avatar + info fields ── */}
        <div>
          {/* Avatar */}
          <div className="flex flex-col items-center py-6 bg-white rounded-2xl border border-gray-100 mb-5">
          ...
          <div className="space-y-3">
            {fields.map((item) => (
              <div key={item.key} className="bg-white p-5 rounded-2xl border border-gray-100 flex items-center gap-4 shadow-sm">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button onClick={() => navigate('/')}
            className="w-full py-4 text-red-500 font-bold text-sm flex items-center justify-center gap-2 hover:bg-red-50 bg-white border border-gray-100 rounded-2xl transition-colors shadow-sm">
