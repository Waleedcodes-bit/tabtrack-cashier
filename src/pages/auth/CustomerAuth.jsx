...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ca-field input[type="text"] {
    width: 100%; height: 42px; padding: 0 42px; border: 1px solid var(--border);
  ...
  .ca-sbar.weak { background: #e24b4a; }
  .ca-sbar.fair { background: #ef9f27; }
  .ca-sbar.good { background: #1db87a; }
  .ca-sbar.strong { background: #0a2e25; }
  .ca-strength-label { font-size: 11px; color: var(--text-light); }
 
  .ca-match-msg { font-size: 11.5px; margin-top: 3px; min-height: 14px; }
  .ca-match-msg.ok { color: var(--green-accent); }
  .ca-match-msg.err { color: #e24b4a; }
  ...
  @media (max-width: 820px) {
    ...
    .ca-hero { width: 100%; padding: 2rem; min-height: auto; }
    .ca-auth-panel { width: 100%; min-height: auto; }
    .ca-hero-headline { font-size: 32px; }
    .ca-reg-grid { grid-template-columns: 1fr; }
  }
`;
...
const Checkbox = ({ checked, small }) => (
  <div
    className={`ca-custom-checkbox${small ? " small" : ""}`}
    style={{
...
const strengthClass = (barIndex, score) => {
  if (barIndex >= score) return "ca-sbar";
  const cls = ["weak", "fair", "good", "strong"];
  return `ca-sbar ${cls[score - 1]}`;
};
    ...
    <div>
      ...
      <div className="ca-field">
        ...
        <div className="ca-input-wrap">
          <svg className="ca-input-icon" viewBox="0 0 24 24">
      ...
      <div className="ca-field">
        <label className="ca-field-label">Password</label>
        <div className="ca-input-wrap">
          <svg className="ca-input-icon" viewBox="0 0 24 24">
          ...
          <input
            ...
            onKeyDown={(e) => e.key === "Enter" && handleSubmit()}
          />
          <button className="ca-eye-btn" onClick={() => setPwVisible(v => !v)} aria-label="Toggle password visibility">
            {pwVisible ? <EyeOnIcon /> : <EyeOffIcon />}
          </button>
        </div>
      </div>

      <div className="ca-remember-row">
        <label className="ca-checkbox-label" onClick={() => setRemembered(v => !v)}>
          <Checkbox checked={remembered} />
          Remember me
        </label>
        <a href="#" className="ca-forgot-link">Forgot password?</a>
      </div>
...
function RegisterForm({ onSuccess }) {
  ...
  const matchMsg = () => {
    if (!pw2) return { text: "", cls: "ca-match-msg" };
    if (pw === pw2) return { text: "✓ Passwords match", cls: "ca-match-msg ok" };
    return { text: "✗ Passwords do not match", cls: "ca-match-msg err" };
  };
  ...
  return (
    <div>
      ...
      <div className="ca-reg-grid">
        <div className="ca-field">
          <label className="ca-field-label">First Name</label>
          <div className="ca-input-wrap">
            <svg className="ca-input-icon" viewBox="0 0 24 24">
        ...
        <div className="ca-field">
          <label className="ca-field-label">Last Name</label>
          <div className="ca-input-wrap">
            <svg className="ca-input-icon" viewBox="0 0 24 24">
              <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
              <circle cx="12" cy="7" r="4" />
      ...
      <div className="ca-field">
        <label className="ca-field-label">Email Address</label>
        <div className="ca-input-wrap">
          <svg className="ca-input-icon" viewBox="0 0 24 24">
            <rect x="2" y="4" width="20" height="16" rx="2" />
            <path d="m2 7 10 7 10-7" />
      ...
      <div className="ca-field">
        ...
        <div className="ca-input-wrap">
          ...
          />
          <button className="ca-eye-btn" onClick={() => setPwVisible(v => !v)} aria-label="Toggle">
            {pwVisible ? <EyeOnIcon /> : <EyeOffIcon />}
          </button>
        </div>
        <div className="ca-pw-strength">
          ...
          <span className="ca-strength-label" style={{ color: pw ? strength.color : undefined }}>
            {strength.label}
          </span>
        </div>
      </div>
      ...
      <div className="ca-field">
        <label className="ca-field-label">Confirm Password</label>
        <div className="ca-input-wrap">
          <svg className="ca-input-icon" viewBox="0 0 24 24">
            <rect x="3" y="11" width="18" height="11" rx="2" />
            <path d="M7 11V7a5 5 0 0 1 10 0v4" />
          ...
          />
          <button className="ca-eye-btn" onClick={() => setPw2Visible(v => !v)} aria-label="Toggle">
            {pw2Visible ? <EyeOnIcon /> : <EyeOffIcon />}
          </button>
        </div>
        <p className={match.cls}>{match.text}</p>
      </div>

      <label className="ca-terms-label" onClick={() => setTermsChecked(v => !v)}>
        <Checkbox checked={termsChecked} small />
        I agree to the{" "}
        <a href="#" className="ca-forgot-link" style={{ fontSize: 13 }}>Terms of Service</a>
        {" "}and{" "}
        <a href="#" className="ca-forgot-link" style={{ fontSize: 13 }}>Privacy Policy</a>
      </label>

      <button className="ca-btn-submit" style={{ marginTop: "1rem" }} onClick={handleSubmit} disabled={loading}>
    ...
    <>
      ...
      <div className="ca-layout">
        ...
        <div className="ca-hero">
          ...
          <div className="ca-brand">
            ...
            <div className="ca-brand-text">
              <span className="ca-brand-name">Navoq</span><br />
              <span className="ca-brand-tag">Customer Portal</span>
            </div>
          </div>
          ...
          <div className="ca-features">
            <div className="ca-feature">
              <div className="ca-feature-icon-wrap">
                <svg viewBox="0 0 24 24"><rect x="2" y="5" width="20" height="14" rx="2" /><path d="M2 10h20" /></svg>
              </div>
              <span className="ca-feature-label">View Balance</span>
            </div>
            <div className="ca-feature">
              <div className="ca-feature-icon-wrap">
                <svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /></svg>
              </div>
              <span className="ca-feature-label">Track Orders</span>
            </div>
            <div className="ca-feature">
              <div className="ca-feature-icon-wrap">
                <svg viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></svg>
              </div>
              <span className="ca-feature-label">Secure &amp; Private</span>
            </div>
          </div>
          ...
          <div className="ca-hero-footer">
            ...
            <div className="ca-footer-links">
              <a href="#">Terms</a>
              <span className="ca-footer-sep">|</span>
              <a href="#">Privacy</a>
            </div>
          </div>
        </div>
        ...
        <div className="ca-auth-panel">
          <button className="ca-back-btn" onClick={() => navigate("/")} aria-label="Go back">
            <svg viewBox="0 0 24 24"><path d="M19 12H5M12 5l-7 7 7 7" /></svg>
          </button>

          <div className="ca-card">
            <div className="ca-card-avatar">
          ...
          <div className="ca-security-note">
            ...
            <div className="ca-security-text">
              <p className="ca-security-title">Your data is protected</p>
              <p className="ca-security-desc">We use industry-standard security<br />to keep your information safe.</p>
            </div>
          </div>
        </div>
